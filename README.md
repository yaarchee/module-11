...
- Данная сборка содержит уже готовый учебный проект

## Developing

### Prerequisites
Для корретной работы необходимо наличие установленного NodeJS. https://nodejs.org/uk/
